...
set tabstop=8                   " Show a (hard) tab as 8 spaces
set smarttab
set tags=tags
...
set smartindent                 " Automatically adds indents when it makes sense
...
set mouse=a              " WHAT? Mouse in the Terminal? Who Knew?
